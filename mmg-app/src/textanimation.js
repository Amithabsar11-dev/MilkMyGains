...
import "./textaniamtion.css";

const Textanimation = ({ setIsLoaded }) => {
  ...
  useEffect(() => {
    ...
    const scrollTrigger = ScrollTrigger.create({
      trigger: ".text-container-animations",
      start: "top top",
      end: "bottom top",
      scrub: true,
  ...
  return (
    <div className="text-container-animations">
        ...
        >
          ...
          <text className="text-path">
            <textPath
              ...
              href="#curve"
            >
              Paneer that works as hard as you do &nbsp;
            </textPath>
            <textPath
              ref={(el) => (textPathRefs.current[1] = el)}
              className="text-path duplicate-text"
              startOffset="100%"
              href="#curve"
            >
              Paneer that works as hard as you do &nbsp;
