...
const cards = [
    ...
    },
    {
        ...
        title: "Stay Lean",
        text:
            "Protein aids fat loss by increasing fullness and boosting metabolism. It requires more energy to digest than carbs or fats, making it doubly effective for fat loss. The most satiating macronutrient that supports a lean and healthier body composition.",
        image: Lean,
        number: "02",
    },
    {
        ...
        text:
            "A high-protein diet nourishes skin, strengthens nails, and promotes vibrant hair, enhancing beauty from within and contributing to a radiant, healthy appearance.",
        image: Yoga,
        number: "03",
    },
];
    ...
    return (
        <div className='about-container'>
            ...
            <div className='about-challenge'>
                ...
                <p className='about-para1'>In an industry dominated by carb-heavy, fat-laden dairy products,<br /> we’re here to rewrite the rules. Our approach isn’t about<br /> compromise; it’s about transformation. We are here to redefine<br /> nutrition for modern high-performance living.</p>
            </div>
            {
                isMobile ? (
